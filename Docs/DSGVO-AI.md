...
Die KI-Features (Geschenkvorschläge, Geburtstagsgrüße) nutzen OpenRouter als Gateway zu Google Gemini. Die Nutzung ist optional und erfordert eine explizite Einwilligung des Nutzers.
...
- **Vorname** der Zielperson (aus Kontaktdaten oder manuell eingetragen)
...
- Demo-Vorschläge werden lokal generiert
- Kein Netzwerkzugriff
- Keine Fehlermeldung für den Nutzer (transparenter Fallback)
