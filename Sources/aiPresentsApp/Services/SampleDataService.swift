...
class SampleDataService {
    static func createSampleData(in context: ModelContext) {
        ...
        let dominik  = person("demo-dominik",isFR ? "Dominique Olivier"   : isES ? "Dominik Guzmán"     : isEN ? "Dominic Hayes"      : "Deniz Arslan",          bday(195, 24), isFR ? "Ami"         : isES ? "Amigo"     : isEN ? "Friend"    : "Freund")
        let helga    = person("demo-helga",  isFR ? "Hélène Clement"      : isES ? "Helena Castillo"    : isEN ? "Helen Peterson"     : "Helga Baumann",         bday(200, 65), isFR ? "Tante"       : isES ? "Tía"       : isEN ? "Aunt"      : "Tante")
