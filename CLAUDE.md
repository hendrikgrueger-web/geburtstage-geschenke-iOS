...
**BEVOR Code geschrieben, ein Feature implementiert, ein Bug gefixt oder ein Release-Schritt gemacht wird:** passenden Skill aus der **Skill-Checkliste** aufrufen (siehe `Apple Apps/CLAUDE.md` → "PFLICHT: Skills vor jeder Aktion prüfen"). Kein Code ohne Skill-Check.

169 Skills verfügbar: 148 Apple-Platform + 21 ASC CLI — alle in `.claude/skills/`.
